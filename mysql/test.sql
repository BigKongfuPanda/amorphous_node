...
coilNetWeight-totalStoredWeight AS unqualifiedWeight,
SUM(c.uselessRibbonWeight) AS uselessRibbonWeight,
SUM(c.meltOutWeight) AS meltOutWeight,
(rawWeight+uselessRibbonWeight)/alloyTotalWeight AS effectiveMeltRatio,
(rawWeight)/(rawWeight+uselessRibbonWeight) AS rollRatio,
totalStoredWeight/rawWeight AS qualifiedRatio,
effectiveMeltRatio*rollRatio*qualifiedRatio AS totalRatio,
